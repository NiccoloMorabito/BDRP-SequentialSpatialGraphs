...
#TODO delete source https://github.com/jensjepsen/imdb-transformer/blob/master/model.py
...
if __name__ == "__main__":
    ...
    Net(embeddings,max_length,model_size=128,num_heads=4,num_blocks=1,dropout=0.1,train_word_embeddings=True):


    input = Variable(torch.rand(40,10,10))
